<?php
require_once getcwd().'/Model/Database.php';
require_once getcwd().'/Model/Drinks.php';
/**
...
class DrinksController {
	...
	$drinks = array();
	while ($singleDrink = $listDrink->fetch_assoc()) {
	$drinksse = array("id_drink" => $singleDrink["id_drink"], "name" => $singleDrink["name"], "description" => $singleDrink["description"], "price" => $singleDrink["price"], "image" => $singleDrink["image"], "size" => $singleDrink["size"], "available" => $singleDrink["available"]);
	$drinks[] = $drinksse;
	}
        return $drinks;
    }
