...
$allDrink = $drinkController->getAllDrink();
?>
                        ...
                        <table id="dynamic-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($allDrink as $key => $value) {
                                    ...
                                    <tr>
                                        <td class="center">
                                            <?php echo $value["id_drink"]; ?>
                                        </td>

                                        <td>
                                            <a href="#"><?php echo $value["name"]; ?> (<?php echo $value["size"]; ?> CL)</a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="index.php?action=editDrinks&idDrink=<?php echo $value["id_drink"]; ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

    <!--<a class="red" href="#" id="<?php echo $value["id_drink"]; ?>" onclick="deletes('<?php echo $value["id_drink"]; ?>')"> </a>-->
                                                <a href="#" id="id-btn-dialog2" onclick="deleteDrink('<?php echo $value["id_drink"]; ?>', '<?php echo $value["name"]; ?>')">
                        ...
                        <div id="dialog-confirm" class="hide">
                            <p class="bigger-110 bolder center grey">
                                ...
                                Sei sicuro di voler cancellare la bevanda selezionata?
                            </p>
                        </div><!-- #dialog-confirm -->
                    </div>
                </div>
